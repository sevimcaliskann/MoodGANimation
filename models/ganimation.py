...
class GANimation(BaseModel):
    ...
    def get_current_visuals(self):
        ...
        visuals['1_input_img'] = np.flip(np.flip(self._vis_real_img, axis =3), axis=1)
        visuals['2_fake_img'] = np.flip(np.flip(self._vis_fake_img, axis=3), axis=1)
        visuals['4_fake_img_unmasked'] = np.flip(np.flip(self._vis_fake_img_unmasked, axis=3), axis=1)
        visuals['5_fake_img_mask'] = np.flip(np.flip(self._vis_fake_img_mask, axis=3), axis=1)
        ...
        visuals['11_batch_fake_img'] = np.flip(np.flip(self._vis_batch_fake_img, axis=3), axis=1)
        visuals['12_batch_fake_img_mask'] = np.flip(np.flip(self._vis_batch_fake_img_mask, axis=3), axis=1)
        visuals['13_batch_real_img'] = np.flip(np.flip(self._vis_batch_real_img, axis=3), axis=1)
