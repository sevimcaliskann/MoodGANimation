...
class GANimation(BaseModel):
    ...
    def get_current_visuals(self):
        ...
        visuals['1_input_img'] = np.flip(self._vis_real_img)
        visuals['2_fake_img'] = np.flip(self._vis_fake_img)
        visuals['4_fake_img_unmasked'] = np.flip(self._vis_fake_img_unmasked)
        visuals['5_fake_img_mask'] = np.flip(self._vis_fake_img_mask)
        visuals['6_first_frame'] = np.flip(self._vis_first_frame)
        ...
        visuals['11_batch_fake_img'] = np.flip(self._vis_batch_fake_img)
        visuals['12_batch_fake_img_mask'] = np.flip(self._vis_batch_fake_img_mask)
        visuals['13_batch_real_img'] = np.flip(self._vis_batch_real_img)
