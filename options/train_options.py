...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--lr_D_temp', type=float, default=0.0001, help='initial learning rate for D adam')
        ...
        self._parser.add_argument('--D_temp_adam_b1', type=float, default=0.5, help='beta1 for D adam')
        ...
        self._parser.add_argument('--lambda_D_temp_gp', type=float, default=10, help='lambda gradient penalty loss')
