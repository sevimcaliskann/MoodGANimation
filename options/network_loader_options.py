...
class NetworkLoaderOptions():
    ...
    def initialize(self):
        parser.add_argument('--model_name', type=str, default='fully_connected', help='model name to load')
        self._parser.add_argument('--data_dir', type=str, help='path to dataset')
        self._parser.add_argument('--train_ids_file', type=str, default='train_ids_whole.csv', help='file containing train ids')
        self._parser.add_argument('--test_ids_file', type=str, default='test_ids_whole.csv', help='file containing test ids')
